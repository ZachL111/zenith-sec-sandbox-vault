...
`zenith-sec-sandbox-vault` is centered on security tooling work in PHP. The technical target is: Implement a PHP security tooling project for sandbox event replay, using fixture event logs and golden state snapshots.
