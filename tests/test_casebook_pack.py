"""Regression checks for the zenith-sec-sandbox-vault casebook."""
...
from casebook.harness import assert_expected, zenith_sec_sandbox_vault_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(zenith_sec_sandbox_vault_summary(), assert_expected())
